...
<header class="w3-display-container w3-content" style="max-width:1500px; margin-top: 67px;">
  <img class="w3-image" src="./img/recipe/2.jpg" alt="The Hotel" style=" width:100%; height:600px;" >
  <div class="w3-display-left w3-padding w3-col l6 m8">
    <div class="w3-container w3-red">
      <h2><i class="fa fa-cutlery w3-margin-right"></i>法式牛軋糖</h2>
    </div>
          ...
          <tr style="border-color: #EFECBA;">
            <td style="padding:0px; width: 40%;  background-color: #EFECBA; border-color: black; border-width: 0px;">
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px; ">
                ...
                <label for="ingredient1">&nbsp 1.蜂蜜 &nbsp</label>
              </dir>
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px;">
                <input type="checkbox" id="ingredient2" class="ingredient">
                <label for="ingredient2">&nbsp 2.砂糖 &nbsp</label>
              </dir>
			        <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px;">
                <input type="checkbox" id="ingredient3" class="ingredient">
                <label for="ingredient3">&nbsp 3.水麥芽 &nbsp</label>
              </dir>
			        <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px;">
                <input type="checkbox" id="ingredient4" class="ingredient">
                <label for="ingredient4">&nbsp 4.堅果 &nbsp</label>
              </dir>
			        <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px;">
                <input type="checkbox" id="ingredient5" class="ingredient">
                <label for="ingredient5">&nbsp 5.蛋 &nbsp</label>
              </dir>
			        <dir style="background-color; width: 100%; margin:10px 0px; padding-left: 50px;">
            ...
            <td style="width: 20%; background-color: #EFECBA;">
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 20px; ">
                <label for="ingredient1">-- 適量</label>
              </dir><dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 20px; ">
                <label for="ingredient1">-- 適量</label>
              </dir><dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 20px; ">
                <label for="ingredient1">-- 適量</label>
              </dir><dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 20px; ">
            ...
            <td style="background-color: #F1DD5D;">
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px; ">
                ...
                <label for="tool1">&nbsp 攪拌器 &nbsp</label>
              </dir>
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px; ">
                <input type="checkbox" id="tool2" class="tool">                
                <label for="tool2">&nbsp 鋼盆 &nbsp</label>
              </dir>
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px; ">
                <input type="checkbox" id="tool3" class="tool">                
                <label for="tool3">&nbsp 鍋子 &nbsp</label>
              </dir>
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px; ">
                <input type="checkbox" id="tool4" class="tool">                
                <label for="tool4">&nbsp 勺子 &nbsp</label>
              </dir>
            </td>
          </tr>
        </table>
  ...
  <div class="w3-container w3-padding-32  " style=" float: right; width: 20%; min-height: 1508px; background-color: #FACA75;">
    ...
    <div id="commment1" class="comment" style="margin-bottom: 10px;  background-color:  #EFECBA; border-radius: 7px;">
      ...
      <div id="commmentUserName" class="commentUserName" style="margin:20px; padding-top: 20px; background-color: ; border-bottom: 3px solid #FF666A;  border-radius: 0px; height: 60px;">二一</div>
    ...
    <div id="commment3" class="comment" style="margin-bottom: 20px;">
      ...
      <div id="commmentUserName" class="commentUserName" >嘟嘟</div>
    ...
    <div id="commment4" class="comment" >
      <div id="commmentUserImg4" style="float: left; padding:10px; height: 40px">
        <img height="40px" width="40px" src="./img/character/4.jpg">
      </div>
      <div id="commmentUserName" class="commentUserName" >阿司</div>
  ...
  <div class=" " style="background-color: #EFECBA; padding: 2%; height:;">
    <div id="step1" class="w3-yellow" style="background-color: ; height: 180px; margin-bottom: 40px; box-shadow: 5px 5px 5px #888888;">
      <div id="video" style="float: left; width: 30%; opacity: ;">
        <iframe width="100%" height="180" src="https://www.youtube.com/embed/a64QaCwxhWA?start=11" frameborder="0" allowfullscreen></iframe>
      </div>
      <dir id="stepContent"  style="background-color: ; margin-left: 30%; padding-top: 20px;">
          <h3 class="w3-section w3-leftbar w3-border-blue  w3-pale-green" style="margin-right: 80%">&nbspStep0: </h3>
    ...
    <div id="step2" class="w3-yellow" style="background-color: pink; height: 180px; margin-bottom: 40px; box-shadow: 5px 5px 5px #888888;">
      <div id="video" style="float: left; width: 30%; opacity: ;">
        <iframe width="100%" height="180" src="https://www.youtube.com/embed/a64QaCwxhWA?start=68" frameborder="0" allowfullscreen></iframe>
      </div>
      <dir id="stepContent" style="background-color:; margin-left: 30%; padding-top: 20px;">
    ...
    <div id="step3" class="w3-yellow" style="background-color: pink; height: 180px; margin-bottom: 40px; box-shadow: 5px 5px 5px #888888;">
      <div id="video" style="float: left; width: 30%; opacity: ;">
        <iframe width="100%" height="180" src="https://www.youtube.com/embed/a64QaCwxhWA?start=229" frameborder="0" allowfullscreen></iframe>
      </div>
      <dir id="stepContent" style="background-color: ; margin-left: 30%; padding-top: 20px; ">
    ...
    <div id="step4" class="w3-yellow" style="background-color: pink; height: 180px; margin-bottom: 40px; box-shadow: 5px 5px 5px #888888;">
      <div id="video" style="float: left; width: 30%; opacity: ;">
        <iframe width="100%" height="180" src="https://www.youtube.com/embed/a64QaCwxhWA?start=433" frameborder="0" allowfullscreen></iframe>
      </div>
      <dir id="stepContent" style="background-color: ; margin-left: 30%; padding-top: 20px;">
	 ...
	 <div id="step5" class="w3-yellow" style="background-color: pink; height: 180px; margin-bottom: 40px; box-shadow: 5px 5px 5px #888888;">
      <div id="video" style="float: left; width: 30%; opacity: ;">
        <iframe width="100%" height="180" src="https://www.youtube.com/embed/a64QaCwxhWA?start=770" frameborder="0" allowfullscreen></iframe>
      </div>
      <dir id="stepContent" style="background-color: ; margin-left: 30%; padding-top: 20px;">
	...
	<div id="step5" class="w3-yellow" style="background-color: pink; height: 180px; margin-bottom: 40px; box-shadow: 5px 5px 5px #888888;">
      <div id="video" style="float: left; width: 30%; opacity: ;">
        <iframe width="100%" height="180" src="https://www.youtube.com/embed/a64QaCwxhWA?start=1062" frameborder="0" allowfullscreen></iframe>
      </div>
      <dir id="stepContent" style="background-color: ; margin-left: 30%; padding-top: 20px;">
