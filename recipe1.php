...
<header class="w3-display-container w3-content" style="max-width:1500px; margin-top: 67px;">
  <img class="w3-image" src="./img/recipe/1.jpg" alt="The Hotel" style=" width:100%; height:600px;" >
  <div class="w3-display-left w3-padding w3-col l6 m8">
    <div class="w3-container w3-red">
      <h2><i class="fa fa-cutlery w3-margin-right"></i>法式脆餅酥皮泡芙</h2>
    </div>
          ...
          <tr style="border-color: #EFECBA;">
            <td style="padding:0px; width: 40%;  background-color: #EFECBA; border-color: black; border-width: 0px;">
              ...
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px;">
                ...
                <label for="ingredient3">&nbsp 3.低筋麵粉 &nbsp</label>
              </dir>
			        <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px;">
                ...
                <label for="ingredient5">&nbsp 5.牛奶 &nbsp</label>
              </dir>
			        <dir style="background-color; width: 100%; margin:10px 0px; padding-left: 50px;">
                <input type="checkbox" id="ingredient6" class="ingredient">
                <label for="ingredient6">&nbsp 6.鹽 &nbsp</label>
              </dir>
			        <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px;">
                <input type="checkbox" id="ingredient7" class="ingredient">
                <label for="ingredient7">&nbsp 7.全蛋 &nbsp</label>
              </dir>
            </td>

            <td style="width: 20%; background-color: #EFECBA;">
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 20px; ">
                <label for="ingredient1">-- 390g</label>
              </dir>
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 20px;">
                <label for="ingredient2">-- 260g</label>
              </dir>
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 20px;">
                <label for="ingredient3">-- 470g</label>
              </dir>
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 20px;">
                <label for="ingredient4">-- 200g</label>
              </dir>
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 20px;">
                <label for="ingredient5">-- 200g</label>
              </dir>
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 20px;">
                <label for="ingredient6">-- 10g</label>
              </dir>
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 20px;">
                <label for="ingredient7">-- 400g</label>
              </dir>
            </td>
            ...
            <td style="background-color: #F1DD5D;">
              ...
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px; ">
                ...
                <label for="tool2">&nbsp 烤箱 &nbsp</label>
              </dir>
              <dir style="background-color:; width: 100%; margin:10px 0px; padding-left: 50px; ">
  ...
  <div class="w3-container w3-padding-32  " style=" float: right; width: 20%; min-height: 1065px; background-color: #FACA75;">
    ...
    <div id="commment1" class="comment" style="margin-bottom: 10px;  background-color:  #EFECBA; border-radius: 7px;">
      ...
      <div id="commmentUserName" class="commentUserName" style="margin:20px; padding-top: 20px; background-color: ; border-bottom: 3px solid #FF666A;  border-radius: 0px; height: 60px;">一郎</div>
  ...
  <div class=" " style="background-color: #EFECBA; padding: 2%; height:;">
    <div id="step1" class="w3-yellow" style="background-color: ; height: 180px; margin-bottom: 40px; box-shadow: 5px 5px 5px #888888;">
      <div id="video" style="float: left; width: 30%; opacity: ;">
        <iframe width="100%" height="180" src="https://www.youtube.com/embed/LF1lDjVAmIo?start=31" frameborder="0" allowfullscreen></iframe>
      </div>
    ...
    <div id="step2" class="w3-yellow" style="background-color: pink; height: 180px; margin-bottom: 40px; box-shadow: 5px 5px 5px #888888;">
      <div id="video" style="float: left; width: 30%; opacity: ;">
        <iframe width="100%" height="180" src="https://www.youtube.com/embed/LF1lDjVAmIo?start=102" frameborder="0" allowfullscreen></iframe>
      </div>
      <dir id="stepContent" style="background-color:; margin-left: 30%; padding-top: 20px;">
    ...
    <div id="step3" class="w3-yellow" style="background-color: pink; height: 180px; margin-bottom: 40px; box-shadow: 5px 5px 5px #888888;">
      <div id="video" style="float: left; width: 30%; opacity: ;">
        <iframe width="100%" height="180" src="https://www.youtube.com/embed/LF1lDjVAmIo?start=170" frameborder="0" allowfullscreen></iframe>
      </div>
      <dir id="stepContent" style="background-color: ; margin-left: 30%; padding-top: 20px; ">
    ...
    <div id="step4" class="w3-yellow" style="background-color: pink; height: 180px; margin-bottom: 40px; box-shadow: 5px 5px 5px #888888;">
      <div id="video" style="float: left; width: 30%; opacity: ;">
        <iframe width="100%" height="180" src="https://www.youtube.com/embed/LF1lDjVAmIo?start=243" frameborder="0" allowfullscreen></iframe>
      </div>
      <dir id="stepContent" style="background-color: ; margin-left: 30%; padding-top: 20px;">
